    ...
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/promotions"> <i class="fas fa-arrow-right"></i> promotions</router-link>
                <router-link @click="scrollToTop()" to="/menu"> <i class="fas fa-arrow-right"></i> menu</router-link>
                <router-link @click="scrollToTop()" to="/table"> <i class="fas fa-arrow-right"></i> book a table</router-link>
            </div>

            <div class="box">
                <h3>extra links</h3>
                <div v-if="user">
                    <router-link @click="scrollToTop()" to="/cart"> <i class="fas fa-arrow-right"></i> my order</router-link>
                    <router-link @click="scrollToTop()" to="/myorder"> <i class="fas fa-arrow-right"></i> my orders</router-link>
                </div>
                <div v-else>
            ...
            <div class="box">
                <h3>opening hours</h3>
                <p>everyday : 09:00am to 10:00pm</p>
            </div>
        </div>

        <div class="bottom">
            <div class="share">
                <a href="https://www.facebook.com/share/1Bjn65aPuh/?mibextid=wwXIfr" class="fab fa-facebook-f"></a>
                <a href="https://x.com/vishalsuthar007?s=21" class="fab fa-twitter"></a>
                <a href="https://www.instagram.com/sujjaaa_?igsh=MTVkMHM2NHN2OTRmaw==" class="fab fa-instagram"></a>
                <a href="https://www.instagram.com/vishalsuthar.007/?igsh=MTVnOHg5NDR4NnpnMg%3D%3D&utm_source=qr#" class="fab fa-instagram"></a>
                
            </div>
            <p class="copyright">© 2025 BUGzz007. All rights reserved.</p>
        </div>
    </div>
</template>
